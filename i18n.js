(() => {
  ...
  const T = {
    ko: {
      ...
      step2Desc: '번호를 입력하면 브라우저에서 바로 전화가 연결됩니다',
      step3Title: '실시간 코칭',
    ...
    ja: {
      ...
      step2Desc: '番号を入力すると、ブラウザからそのまま電話がつながります',
    ...
    en: {
      ...
      step2Desc: 'Enter the number and the call connects right from your browser',
